...
class Config:
    ...
    ZALO_REDIRECT_URI = os.getenv('ZALO_REDIRECT_URI', 'https://elcom.vn/zalo-auth-exclusive-callback')
    ...
    FB_REDIRECT_URI = os.getenv('FB_REDIRECT_URI', 'https://elcom.vn/facebook-callback')
